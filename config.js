...
mapkey("k", "Scroll down", () => { Normal.scroll("pageDown"); });
map('I', 'U');  // scroll full page up
map('K', 'P');  // scroll full page down -- looks like we can't overwrite browser-native binding
